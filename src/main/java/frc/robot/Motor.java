...
import org.roxbotix.elibs2.motor.SharedMotorCore;
import org.roxbotix.elibs2.motor.SparkCore;
import org.roxbotix.elibs2.motor.TalonCore;
 ...
 *
 * <p>
 * Do yourself a favor and go check out the {@link MotorConfig} class to figure
 * out how motor configurations work. Or don't - you don't have to. Your
 * choice, y'know?
 * </p>
 *
 * <p>
...
public class Motor implements
     ...
     */
    private org.roxbotix.elibs2.motor.SharedMotorCore motor;
    ...
    private void msgNew(MotorConfig motorConfig) {
        System.out.println(
    ...
    /**
     * Send the user a message about the motor's construction.
     *
     * <p>
     * Although not really needed, I've found it's rather helpful when you're
     * at a competition and screaming "why isn't the robot effing moving?"
     * </p>
     *
     * @param motorConfig the motor's configuration.
     */
    private void sendUserMessage(MotorConfig motorConfig) {
        System.out.println(
                tag + consTag + "New motor constructed with ID " + motorConfig.id
        );
        System.out.println(
     ...
     *
     * <p>
     * As a fair warning. Please be careful about what you put in your robot
     * configuration. Running a motor in the wrong mode can cause permanent
     * damage to the motor or motor controller.
     * </p>
     *
     * <p>
     * Double-check that BRUSHED motors are running in BRUSHED mode.
     * Double-check that BRUSHLESS motors are running in BRUSHLESS mode.
     * </p>
     *
     * @param motorConfig the motor's configuration.
     */
    ...
    private void buildMotor() {
        switch (type) {
            case TALON:
                ...
                break;
            case SPARK_BRUSHED:
                motor = new org.roxbotix.elibs2.motor.SparkCore(
                        id,
