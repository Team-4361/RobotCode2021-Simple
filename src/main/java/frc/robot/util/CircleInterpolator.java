...
/**
 * Interpolate circles by drawing one-dimensional rays at a specified
 * angle until a certain arc length (uses degrees, not distance) is
 * met. Inverted degree sets must be flipped and reflected over a
 * central axis. 
 * 
